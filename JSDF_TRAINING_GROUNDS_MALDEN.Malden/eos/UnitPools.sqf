...
// ADD CLASSNAMES 
	if (_faction==5) then {
	_InfPool=	["rhs_vmf_recon_sergeant","rhs_vmf_recon_efreitor","rhs_vmf_recon_arifleman","rhs_vmf_recon_machinegunner_assistant","rhs_vmf_recon_rifleman_lat","rhs_vmf_recon_grenadier"];	
	_ArmPool=	[];
	_MotPool=	[];
	_ACHPool=	[];
	_CHPool=	[];
